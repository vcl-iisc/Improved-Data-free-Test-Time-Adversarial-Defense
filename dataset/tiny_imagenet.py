...
class TinyImagenet(object):
    def __init__(self, input_size = 224):
        ...
        data_dir = 'clean_data/tiny-imagenet-200'
        ...
        self.dataloaders = {x: data.DataLoader(self.image_datasets[x], batch_size=256, shuffle=True, num_workers=num_workers[x])
                  for x in ['train', 'val', 'test']}
    ...
    def test_dataset_without_normalization(self):
        return self.image_datasets["val"]
