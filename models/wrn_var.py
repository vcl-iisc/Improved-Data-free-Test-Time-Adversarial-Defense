...
class WideResNetVar(nn.Module):
    def __init__(self, first_stride, num_classes, depth=28, widen_factor=2, drop_rate=0.0, is_remix=False,dad_droprate=0.0):
        ...
        self.dad_dropout = nn.Dropout(dad_droprate)
        print(f'Using Dropout ({dad_droprate})')
...
class build_WideResNetVar:
    def __init__(self, first_stride=1, depth=28, widen_factor=2, bn_momentum=0.01, leaky_slope=0.0, dropRate=0.0,
                 use_embed=False, is_remix=False, dad_droprate=0.0):
        ...
        self.is_remix = is_remix
        self.dad_droprate = dad_droprate
    ...
    def build(self, num_classes):
        return WideResNetVar(
            ...
            dad_droprate = self.dad_droprate
        )
